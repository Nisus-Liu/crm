                    ...
                    <TR>
                        <TD height=35 align="right">
                            ...
                            <s:if test="#session.current_user==null">
                                <A href="${pageContext.request.contextPath}/user_goLoginUI" target=_top><FONT color=red>登录</FONT></A>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <A href="#" target=_top><FONT color=red>注册</FONT></A>
                            </s:if>
                            <s:if test="#session.current_user!=null">
                                当前用户：<s:property value="#session.current_user.user_name"/>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <A href="#" target=_top><FONT color=red>修改密码</FONT></A>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <A href="${pageContext.request.contextPath}/user_logout" target=_top><FONT color=red>安全退出</FONT></A>
                            </s:if>
                            <%--//根据是否登录改变内容--%>
