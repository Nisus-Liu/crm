    ...
    <script type="text/javascript">
        window.onload=function () {
            if(window.parent != window) {
                window.parent.location.href = "${pageContext.request.contextPath}/user_goLoginUI";
            }
        }
                    ...
                    <TD background=images/login_2.jpg height=300>
                        <TABLE height=300 cellPadding=0 width=900 border=0>
                            ...
                            <TR>
                                <TD width=360></TD>
                                <TD>
                                    <label style="font-size: 20px;color: #ff0000;">提示: <s:property
                                            value="exception.message"/></label>
