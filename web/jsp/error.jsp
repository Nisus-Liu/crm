            ...
            <table width="100%" height=200 border="0" cellpadding="0"
                ...
                <tr>
                    <td align="center" style="font-size: 14px;"><img
                        ...
                        <%--错误|信息提示区域--%>
                        <%--error:--%>
                        <span style="vertical-align: middle"><s:property value="#error"/></span>
                        <%--info--%>
                        <span style="vertical-align: middle"><s:property value="#info"/></span>
                        <%--exception:--%>
                        <span style="vertical-align: middle"><s:property value="exception.message"/></span>
                    </td>
                </tr>
            </table>
        </td>
